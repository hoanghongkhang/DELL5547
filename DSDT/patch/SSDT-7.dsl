 ...
 *
 * Disassembly of SSDT-7.aml, Mon Sep 18 07:36:31 2017
 *
 ...
 */
DefinitionBlock ("", "SSDT", 1, "COMPAL", "CRV ORB ", 0x00003000)
{
    /*
     * iASL Warning: There were 17 external control methods found during
     * disassembly, but only 15 were resolved (2 unresolved). Additional
    ...
    OperationRegion (SANV, SystemMemory, 0x9AFB5D98, 0x0141)
        ...
        Device (IGPU)
        {
            ...
            Device (DD1F)
            {
                ...
                Method (_BCM, 1, NotSerialized)  // _BCM: Brightness Control Method
                {
                    ...
                    ElseIf (LAnd (LGreaterEqual (Arg0, Zero), LLessEqual (Arg0, 0x64)))
                    {
                ...
                Method (_BQC, 0, NotSerialized)  // _BQC: Brightness Query Current
                {
                    If (LGreaterEqual (OSYS, 0x07DC))
                    {
                        Store (And (\_SB.PCI0.IGPU.CBLV, 0xFF), Local0)
                        Return (Local0)
                    }
                    Else
                    {
