 ...
 *
 * Disassembly of DSDT.aml, Mon Sep 18 07:36:31 2017
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000E06E (57454)
...
DefinitionBlock ("", "DSDT", 1, "DELL  ", "CL09   ", 0x00000000)
{
     ...
     * disassembly, but only 16 were resolved (8 unresolved). Additional
                    ...
                    Name (BUF0, ResourceTemplate()
{
    IRQNoFlags() { 0, 8, 11, 15 }
                ...
                Device (PS2K)
                {
                    Name (_HID, "DLLK063E")  // _HID: Hardware ID
                ...
                Device (PS2M)
                {
                    Name (_HID, "DLL063F")  // _HID: Hardware ID
    ...
    Scope (_SB.PCI0)
    {
        ...
        Scope (I2C1)
        {
            ...
            {
                Name (_ADR, One)  // _ADR: Address
                Name (_HID, "DLL063E")  // _HID: Hardware ID
                Name (_CID, "PNP0C50")  // _CID: Compatible ID
                Name (_UID, One)  // _UID: Unique ID
                Name (_S0W, 0x04)  // _S0W: S0 Device Wake State
                Method (XDSM, 4, NotSerialized)  // _DSM: Device-Specific Method
